...
const TIERS = [
  {
    ...
    features: [
      ...
      "Appointments, referrers, documents & compliance logs",
      "Digital invoicing & printable reports",
      "Current-month reports (CSV/PDF export)",
  ...
  },
  {
    ...
    features: [
      ...
      "Digital invoicing & printable reports",
      "3 months of reports (CSV/PDF export)",
      "Standard role set (fixed)",
    ],
  },
  {
    ...
    features: [
      ...
      "6 months of revenue & test-volume reports (CSV/PDF export)",
      "Priority support",
    ],
  },
  {
    ...
    features: [
      "Everything in Pro",
      "Multi-branch locations sharing one patient registry",
      "12 months of reports (CSV/PDF export)",
